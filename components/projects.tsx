...
const projects = [
  ...
  },
  {
    ...
    description: "A powerful SaaS platform that leverages AI to automate content creation, improve SEO, and provide valuable insights into customer sentiment.",
    tags: ["TypeScript", "Next", "Framer Motion", "supabase", "HuggingFace", "Gemini", "PayPal"],
    category: "Full-stack",
    image: "/assets/ai-content-gen-landing-page-image.png?height=300&width=400",
    github: "https://github.com/MeeksonJr/ai-content-generator",
    live: "https://ai-content-generator-mu-seven.vercel.app/",
  },
  {
    title: "EduSphere AI",
    description: "EduSphere AI is a modern full-stack SaaS platform designed to support students from K–University with AI-powered academic tools, personalized learning assistance, and productivity features — all within a sleek, dark-themed interface.",
    tags: ["TypeScript", "Next", "Framer Motion", "supabase", "HuggingFace", "Gemini", "PayPal"],
    category: "Full-stack",
